...
def run_web_interface():
    with gr.Blocks() as demo:
        ...
        with gr.Row():
            header = gr.Markdown(
                value='<h1 align="center">📝 Генерация описания бизнес-задачи</h1>'
            )
        with gr.Row():
            with gr.Column():
        ...
        with gr.Row():
            ...
            with gr.Column():
                markdown = gr.Markdown(
                    label="Результат", max_height=500, value=state.value["md_value"]
                )
        with gr.Row():
            with gr.Column():
                pass
        ...
        submit_button.click(
            ...
            fn=action_push_submit_button,
            show_progress_on=[user_input, submit_button],
        )
